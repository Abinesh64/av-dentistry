...
import { CLINIC, FOOTER_LINKS } from "@/lib/data";
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center gap-2">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary text-lg font-bold text-white">
                AV
              </span>
              <span className="text-xl font-bold text-white">{CLINIC.name}</span>
            </div>
            <p className="mt-4 text-sm leading-relaxed">{CLINIC.tagline}</p>
